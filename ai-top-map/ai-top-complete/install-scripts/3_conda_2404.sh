...
git clone --branch master --single-branch --depth 1 https://github.com/NVIDIA/nccl.git nccl && cd nccl && git fetch --unshallow && git checkout 25368a7f78bae866f29e46938af94fa586c84484
...
make pkg.debian.build -j 8
ls build/pkg/deb/
cd ~/.conda/envs/$MINIFORGE_ENV/lib/python3.10/site-packages/nccl/build/pkg/deb/
sudo dpkg -i libnccl2_2.29.3-1+cuda13.0_amd64.deb # IDK why version is 2.27.5-1
sudo dpkg -i libnccl2_2.29.3-1+cuda13.0_amd64.deb
sudo apt --fix-broken install -y
dpkg-query --showformat='${Package} ${Version}\n' --show libnccl2 libnccl-dev 

pip install pybind11==2.11.3 

echo "Reinstall pytorch....."
