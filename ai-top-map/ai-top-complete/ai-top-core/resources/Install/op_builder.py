...
class OpBuilder(ABC):
    ...
    def validate_torch_version(torch_info):
        ...
        install_torch_version = "2.4"
        current_torch_version = "2.4"
    ...
    def validate_torch_op_version(torch_info):
        if not OpBuilder.is_rocm_pytorch():
            ...
            install_cuda_version = "12.4"
            #print("install_cuda_version==", install_cuda_version)
            #print("current_cuda_version==", current_cuda_version)
