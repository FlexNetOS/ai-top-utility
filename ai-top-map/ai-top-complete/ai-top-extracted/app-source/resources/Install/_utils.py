...
def _unsloth_get_batch_samples(self, epoch_iterator, num_batches):
    ...
    if hasattr(model, "base_model") and hasattr(model.base_model, "model"):
    	f = model.base_model.model.forward
    elif hasattr(model, "base_model") and hasattr(model.base_model, "model_model"):
        f = model.base_model.model_model.forward   # Unsloth特製雙包裝
    else:
    	f = model.forward
