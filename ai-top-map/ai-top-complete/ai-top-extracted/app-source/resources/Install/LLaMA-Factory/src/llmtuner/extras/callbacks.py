...
class LogCallback(TrainerCallback):
    ...
    def on_train_begin(self, args: "TrainingArguments", state: "TrainerState", control: "TrainerControl", **kwargs):
        ...
        if state.is_local_process_zero:
            ...
            if os.path.exists(os.path.join(args.output_dir, TRAINER_LOG)) and args.overwrite_output_dir:
    ...
    def on_substep_end(self, args: "TrainingArguments", state: "TrainerState", control: "TrainerControl", **kwargs):
        ...
        """
        if state.is_local_process_zero and self.runner is not None and self.aborted:
    ...
    def on_step_end(self, args: "TrainingArguments", state: "TrainerState", control: "TrainerControl", **kwargs):
        ...
        if state.is_local_process_zero:
            ...
            self.timing()
            if self.runner is not None and self.aborted:
                control.should_epoch_stop = True
                control.should_training_stop = True
